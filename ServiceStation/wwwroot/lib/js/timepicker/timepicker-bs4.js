		...
		$content.find('.clock-input-table button').each(function () {
			...
			if (pos > 0)
			{
				...
				positions.forEach(function (pos) {
					disabled = disabled && (options.unitText[view][pos] === null);
				});
...
function updatePicker($input)
{
    ...
    let html = '<div class="clock-input' + (clock_enabled ? '' : ' d-none') + '">'
        ...
        + '<td class="text-center align-bottom" colspan="3"><a id="' + input_id + '-picker-add-link" class="btn btn-link time-md-100p px-1 mx-0 chevron-btn" data-step="1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_less</span></a></td>'
        ...
        + '<td class="text-center" colspan="3"><a id="' + input_id + '-picker-sub-link" class="btn btn-link time-md-100p px-1 mx-0 chevron-btn" data-step="-1" href="javascript:void(0)"><i class="fs-md-xxs material-icon-symbols-outlined">expand_more</i></a></td>'
        ...
        + '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="hour" data-step="1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_less</span></a></td>'
        + '<td></td>'
        + '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="minute" data-step="1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_less</span></a></td>'
        + (has_second ? '<td></td><td><a class="btn btn-link n-underlinetime-md-100p px-1 mx-0 chevron-btn" data-unit="second" data-step="1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_less</span></a></td>' : '')
        + (clock_24 ? '' : '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="meridiem" data-step="1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_less</span></a></td>')
        + '</tr><tr>'
        + '<td><select class="form-control text-center border-light hour-input">';
            for (var hour_index = 0; hour_index < 24; hour_index++) {
                html += "<option value='" + hour_index + "'>" + hour_index + "</option>";
            }
        html += '</select></td>' + '<td>:</td>'
        + '<td><select class="form-control text-center border-light minute-input">';
            for (var minute_index = 0; minute_index < 60; minute_index++) {
                html += "<option value='" + minute_index.toString().padStart(2, "0") + "'>" + minute_index.toString().padStart(2, "0") + "</option>";
            }
        html += '</select></td>'
		...
		+ '</tr><tr>'
            + '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="hour" data-step="-1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_more</span></a></td>'
		+ '<td></td>'
            + '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="minute" data-step="-1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_more</span></a></td>'
            + (has_second ? '<td></td><td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="second" data-step="-1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_more</span></a></td>' : '')
            + (clock_24 ? '' : '<td><a class="btn btn-link n-underline time-md-100p px-1 mx-0 chevron-btn" data-unit="meridiem" data-step="-1" href="javascript:void(0)"><span class="fs-md-xxs material-icon-symbols-outlined">expand_more</span></a></td>')
		+ '</tr></table></div>'
        ...
        + '<div><button type="button" class="btn btn-secondary mx-1 cancel-btn" data-dismiss="popover" title="Cancel"><span>Cancel</span></button><button type="button" class="btn btn-primary mx-1 submit-btn" title="OK"><span>OK</span></button></div>'
		+ '</div>';
